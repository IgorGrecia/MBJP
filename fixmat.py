...
if os.path.isfile("Text\\new.txt"):
    os.remove("Text\\new.txt")
fbody = open("Text\\Mat MB.txt", "r",encoding='utf8')
if os.path.isfile("Text\\Mat MB Fixed.txt"):
    os.remove("Text\\Mat MB Fixed.txt")
f3 = open("Text\\Mat MB Fixed.txt", "a",encoding='utf8')
...
if os.path.isfile("Text\\new.txt"):
    os.remove("Text\\new.txt")
fbody = open("Text\\Mat MBF.txt", "r",encoding='utf8')
if os.path.isfile("Text\\Mat MBF Fixed.txt"):
    os.remove("Text\\Mat MBF Fixed.txt")
f3 = open("Text\\Mat MBF Fixed.txt", "a",encoding='utf8')
f2 = open("Text\\new.txt", "w",encoding='utf8')
reader = fbody.read()
reader = reader.replace("<br></div></div>", "<br></div></div>\n")
reader = reader.replace("\n</body>", "")
