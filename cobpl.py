...
class MyHTMLParser(HTMLParser):
    ...
    def handle_data(self, data):
        if self.counter == 3:
            ...
            msg["Subject"] = "Maple Bear - Financeiro"   #The subject line
...
school = "1"
mode = "1"
fbody = open("Text\\MB At Rem MatArras.txt", "r",encoding="utf8")
for line in fbody:
    parser = MyHTMLParser()
    parser.feed(line)
fbody.close()
...
school = "1"
mode = "2"
fbody = open("Text\\MB Inat Rem MatArras.txt", "r",encoding="utf8")
for line in fbody:
    parser = MyHTMLParser()
    parser.feed(line)
fbody.close()
...
school = "2"
mode = "1"
fbody = open("Text\\MBF At Rem MatArras.txt", "r",encoding="utf8")
for line in fbody:
    parser = MyHTMLParser()
    parser.feed(line)
fbody.close()
...
school = "2"
mode = "2"
fbody = open("Text\\MBF Inat Rem MatArras.txt", "r",encoding="utf8")
for line in fbody:
    parser = MyHTMLParser()
    parser.feed(line)
fbody.close()
